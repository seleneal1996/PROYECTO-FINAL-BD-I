...
<html>
    ...
    <body>
        ...
        String tabla_nombre="stock_sucursal";
        String usuario="root";
        String clave="root";
        try{
                ...
                String select_value="SELECT * FROM stock_sucursal INNER JOIN modelo as m ON m.Codigo= Modelo_Codigo WHERE Sucursal_idSucursal = "+idSucursal;
                ...
                out.print("<a href=\"agregarModelo.jsp?idSucursal="+idSucursal+"\"><button> Agregar</button></a>");
                conexion.close();
        }catch(Exception ex){
